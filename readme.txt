Grupo 24
	...
	Agustin Leidi 16136/0

	Matias Diz Rendani 17149/0

	Felix Francisco Rodriguez Sandoval 17266/6
...
DIFÍCIL, CARGAR PARTIDA, PUNTOS POR LETRA, ACEPTAR o SALIR DE ScrabbleAR.

Si el usuario quiere iniciar una partida, debe presionar cualquiera de las opciones
anteriormente mencionadas, exceptuando 'PUNTOS POR LETRA' y 'SALIR DE ScrabbleAR'.

Cada nivel cuenta con un tablero distinto según el grado de la dificultad.

La opción 'PUNTOS POR LETRA' permite modificar el puntaje de las letras a gusto.

El nivel "Personalizado" permite al usuario configurar ciertos aspectos del juego.
